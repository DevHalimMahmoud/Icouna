...
public class HomeProductRecyclerViewAdapter extends RecyclerView.Adapter<HomeProductRecyclerViewAdapter.ViewHolder> {
    ...
    public HomeProductRecyclerViewAdapter(int layoutId, ArrayList<Awards> itemList) {
    ...
    @Override
    public HomeProductRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(listItemLayout, parent, false);

        return new HomeProductRecyclerViewAdapter.ViewHolder(view);
    }

    // load data in each row element
    @Override
    public void onBindViewHolder(final HomeProductRecyclerViewAdapter.ViewHolder holder, final int listPosition) {
