...
public class ServicesArrayAdapter extends RecyclerView.Adapter<ServicesArrayAdapter.ViewHolder> {
    ...
    public ServicesArrayAdapter(int layoutId, ArrayList<Service> itemList) {
